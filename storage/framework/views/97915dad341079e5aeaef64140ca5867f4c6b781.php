	...
	<?php $__env->startSection('content'); ?>
		<div class="row">
			<?php if(Entrust::can('create_expense')): ?>
			<div class="col-sm-12 collapse" id="box-detail">
				<div class="box-info">
					...
					<?php echo Form::open(['route' => 'expense.store','role' => 'form', 'files' => 'true', 'class'=>'expense-form','id' => 'expense-form','data-form-table' => 'expense_table']); ?>
