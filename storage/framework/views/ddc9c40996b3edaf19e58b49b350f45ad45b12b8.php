...
<ul class="breadcrumb">
		...
		<li class="active"><?php echo trans('messages.appraisal_user'); ?></li>
	</ul>
...
<div class="row">
		...
		<div class="col-sm-12">
			<div class="box-info full">
				<h2><strong><?php echo trans('messages.appraisal_user'); ?></strong> (<?php echo count($appraisal_list_array);?>)
				</h2>
				...
				<div class="table-responsive">
					...
					<table class="table table-hover" id="supervisor_table" width="100%">
						...
						for($i=0;$i<$count;$i++)
						{
							...
							<a href="/appraisal_user_view/?uid='.$uid.'" target="_blank">
							<button data-toggle="tooltip" title="View" class="btn btn-success btn-xs" type="button"><i class="fa fa-eye"></i> </button>
							</a>

							<a href="/appraisal_user_edit/?uid='.$uid.'" target="_blank">
							<button data-toggle="tooltip" title="Edit" class="btn btn-success btn-xs" type="button"><i class="fa fa-edit"></i> </button>
							</a>
