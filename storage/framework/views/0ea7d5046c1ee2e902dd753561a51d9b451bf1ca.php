		...
		<div class="row">
			<div class="col-sm-12">
				<div class="box-info full">
					...
					<?php if(Entrust::can('generate_payroll')): ?>
					<div class="additional-btn">
						<a href="/payroll/create"><button class="btn btn-sm btn-primary"><i class="fa fa-plus icon"></i> <?php echo trans('messages.generate_new_payroll'); ?></button></a>
					</div>
					<?php endif; ?>
					</h2>
