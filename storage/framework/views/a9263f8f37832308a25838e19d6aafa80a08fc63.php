	...
	<?php $__env->startSection('content'); ?>
		<div class="row">
			<?php if(Entrust::can('create_award')): ?>
			<div class="col-sm-12 collapse" id="box-detail">
				<div class="box-info">
					<h2><strong><?php echo trans('messages.add_new'); ?></strong> <?php echo trans('messages.award'); ?>
					...
					<?php echo Form::open(['route' => 'award.store','role' => 'form', 'class'=>'award-form','id' => 'award-form','data-form-table' => 'award_table']); ?>
