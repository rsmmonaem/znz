	<?php $__env->startSection('breadcrumb'); ?>
		<ul class="breadcrumb">
		    ...
		    <li class="active"><?php echo trans('messages.ticket'); ?></li>
		</ul>
	<?php $__env->stopSection(); ?>
	
	<?php $__env->startSection('content'); ?>
		<div class="row">
			<?php if(Entrust::can('create_ticket')): ?>
			<div class="col-sm-12 collapse" id="box-detail">
				<div class="box-info">
					<h2><strong><?php echo trans('messages.add_new'); ?></strong> <?php echo trans('messages.ticket'); ?>
					...
					<?php echo Form::open(['route' => 'ticket.store','role' => 'form', 'class'=>'ticket-form','id' => 'ticket-form','data-form-table' => 'ticket_table']); ?>

						<?php echo $__env->make('ticket._form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
					<?php echo Form::close(); ?>
			...
			<div class="col-sm-12">
				<div class="box-info full">
					<h2><strong><?php echo trans('messages.list_all'); ?></strong> <?php echo trans('messages.ticket'); ?>
