	...
	<?php $__env->startSection('content'); ?>
		<div class="row">
			<?php if(Entrust::can('create_announcement')): ?>
			<div class="col-sm-12 collapse" id="box-detail">
				<div class="box-info">
					...
					<?php echo Form::open(['route' => 'announcement.store','role' => 'form', 'class'=>'announcement-form','id' => 'announcement-form','data-form-table' => 'announcement_table']); ?>
