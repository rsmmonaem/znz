	...
	<?php $__env->startSection('content'); ?>
		<div class="row">
			...
			<div class="col-sm-12 collapse" id="box-detail">
				<div class="box-info">
					<h2><strong><?php echo trans('messages.add_new'); ?></strong> <?php echo trans('messages.job'); ?>
					...
					<?php echo Form::open(['route' => 'job.store','role' => 'form', 'class'=>'job-form','id' => 'job-form','data-form-table' => 'job_table']); ?>
