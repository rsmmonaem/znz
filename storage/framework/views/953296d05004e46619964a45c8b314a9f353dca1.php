			  ...
			  <div class="form-group">
				...
				<?php endif; ?>	
				<div class="help-box"><?php echo trans('messages.not_editable'); ?></div>
			  </div>
			  <div class="form-group">
			    <?php echo Form::label('name',trans('messages.language_name'),[]); ?>

				<?php echo Form::input('text','name',isset($locale) ? config('lang.'.$locale.'.language') : '',['class'=>'form-control','placeholder'=>trans('messages.language_name')]); ?>
