				  ...
				  {!! Form::label('visibility',trans('messages.visibility'),['class' => 'col-sm-2'])!!}
					<div class="col-sm-10">
						<label class="checkbox-inline">
							<input type="radio" name="visibility" id="visibility" value="private" {{ (isset($todo->visibility) && $todo->visibility != 'public') ? 'checked' : '' }}  > {!! trans('messages.private') !!}
						</label>
						<label class="checkbox-inline">
							<input type="radio" name="visibility" id="visibility" value="public" {{ (isset($todo->visibility) && $todo->visibility == 'public') ? 'checked' : '' }}> {!! trans('messages.public') !!}
						</label>
					</div>
					<div class="clear"></div>
