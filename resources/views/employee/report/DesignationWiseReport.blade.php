...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="active">Designation Wise Report</li>
    </ul>
@stop
...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="box-info">
                <h2 class="text-center"><strong>Designation Wise Report</strong></h2>
                <div class="container">
                    ...
                    <div class="table-container">
                        <div class="display-flex">
                            ...
                            <div class="center-item">
                                ...
                                <h2 style="margin:0;">Designation Wise Report</h2>
                            </div>
                        </div>
