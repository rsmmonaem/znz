...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="active">Advance DeductionRport</li>
    </ul>
@stop
...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="box-info">
                <h2 class="text-center"><strong>Advance DeductionRport</strong></h2>
                <div class="container">
...
@section('javascript')
    ...
    response.data.forEach((item, index) => {
        // Sort months_with_advance_salary for each individual item
        const sortedMonths = Array.isArray(item.months_with_advance_salary) ? 
            item.months_with_advance_salary.sort((a, b) => {
                return monthOrder.indexOf(a.month) - monthOrder.indexOf(b.month);
            }) : []; // If not defined, use an empty array
        
        const monthsSummary = monthOrder.map(month => {
            // Find corresponding month data for the current item
            const monthData = sortedMonths.find(monthItem => monthItem.month === month);
            return `<td>${monthData ? monthData.advance_salary || ' ' : ' '}</td>`;
        }).join('');
            ...
            <div class="table-container">
                <div class="display-flex">
                    ...
                    <div class="center-item">
                        ...
                        <h2 style="margin:0;">Advance Deduction Report</h2>
                    </div>
                </div>
