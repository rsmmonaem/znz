...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="active">Religion Wise Report</li>
    </ul>
@stop
...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="box-info">
                <h2 class="text-center"><strong>Religion Wise Report</strong></h2>
                <div class="container">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#report').click(function() {
                ...
                var reliagion = $('select[name="reliagion"]').val();
        ...
        function GetReport(response) {
            ...
            const reportHTML = `
                <html>
                <head>
                    <title>Religion Wise Report</title>
                    <style>
                        body {
                    ...
                    <div class="table-container">
                        <div class="display-flex">
                            ...
                            <div class="center-item">
                                ...
                                <h2 style="margin:0;">Religion Wise Report</h2>
                            </div>
                        </div>
