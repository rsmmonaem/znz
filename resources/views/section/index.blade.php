	...
	@section('content')
		<div class="row">
			...
			<div class="col-sm-12 collapse" id="box-detail">
				<div class="box-info">
					<h2><strong>{!! trans('messages.add_new') !!}</strong> {!! trans('messages.section') !!}
					...
					{!! Form::open(['route' => 'sections.store','role' => 'form', 'class'=>'designation-form','id' => 'designation-form','data-form-table' => 'designation_table']) !!}
			...
			<div class="col-sm-12">
				<div class="box-info full">
					<h2><strong>{!! trans('messages.list_all') !!}</strong> {!! trans('messages.section') !!}
					<div class="additional-btn">
						@if(Entrust::can('create_designation'))
						...
						<table class="table table-hover" id="designation_table">
							...
							<tbody>
								@foreach($branch as $designation)
									<tr>
										<td><div class="btn-group btn-group-xs">{!! Entrust::can('edit_designation') ? '<a href="#" data-href="/sections/'.$designation->id.'/edit" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModal"> <i class="fa fa-edit" data-toggle="tooltip" title="'.trans('messages.edit').'"></i></a> ' : '' !!}
										{!! Entrust::can('delete_designation') ? delete_form(['sections.destroy',$designation->id],'designation',1) : ''  !!}</div></td>
