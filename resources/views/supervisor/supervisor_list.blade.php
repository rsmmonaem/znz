...
@extends('layouts.default')
	...
	<ul class="breadcrumb">
		    ...
		    <li class="active">{!! trans('messages.supervisor_list') !!}</li>
		</ul>
	@stop
	...
	<div class="row">
			...
			<div class="col-sm-12 collapse" id="box-detail">
				<div class="box-info">
					<h2><strong>{!! trans('messages.add_new') !!}</strong> {!! trans('messages.supervisor_list_menu') !!}
			...
			<div class="col-sm-12">
				<div class="box-info full">
					<h2><strong>{!! trans('messages.list_all') !!}</strong> {!! trans('messages.supervisor_list_menu') !!} (<?php echo count($supervis_list);?>)
						<div class="additional-btn">
							<!-- @if(Entrust::can('create_employee')) -->
