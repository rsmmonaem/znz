			<div class="col-sm-6">
			  <div class="form-group">
				...
				{!! Form::input('text','company_name',(config('config.company_name')) ? : '',['class'=>'form-control','placeholder'=>trans('messages.company_name')])!!}
			  </div>
			  <div class="form-group">
			    {!! Form::label('contact_person',trans('messages.contact_person'),[])!!}
				{!! Form::input('text','contact_person',(config('config.contact_person')) ? : '',['class'=>'form-control','placeholder'=>trans('messages.contact_person')])!!}
			  </div>
			  <div class="form-group">
			    {!! Form::label('email',trans('messages.email'),[])!!}
				{!! Form::input('email','email',(config('config.email')) ? : '',['class'=>'form-control','placeholder'=>trans('messages.email')])!!}
			  </div>
			  <div class="form-group">
			    {!! Form::label('phone',trans('messages.phone'),[])!!}
				{!! Form::input('number','phone',(config('config.phone')) ? : '',['class'=>'form-control','placeholder'=>trans('messages.phone')])!!}
			  </div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
					...
					<br />
					{!! Form::select('country_id', [''=>''] + config('country'),(config('config.country_id')) ? : '',['class'=>'form-control input-xlarge select2me','placeholder'=>trans('messages.country')])!!}
				</div>
