...
<ul class="breadcrumb">
		...
		<li class="active">{!! trans('messages.appraisal_rating') !!}</li>
	</ul>
@stop
...
<div class="row">
		...
		<div class="col-sm-12">
			<div class="box-info full">
				<h2><strong>{!! trans('messages.list_all') !!}</strong> (<?php echo count($appraisal_list_array);?>)
				</h2>
