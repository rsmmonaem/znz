@extends('layouts.default')
	...
	@section('breadcrumb')
		<ul class="breadcrumb">
		    ...
		    <li class="active">{!! trans('messages.appraisal_rating_menu') !!}</li>
		</ul>
	@stop
  ...
  $disabled_1='';
  if($appraisal_array[0]['hr_approve']==1){$disabled_1='disabled';}
  ...
  ?>
	...
	<h2><strong>{!! trans('messages.appraisal_rating_menu') !!}</strong>
	</h2>

<form id="appraisal_review_edit_1" action="/appraisal_review_edit_save" method="Post"></form>
...
<div class="col-sm-12">
	<table width="100%" border="1" cellspacing="2" cellpadding="5">
  <tr>
    <td class="" colspan="4" style="color:#fff;background:#666666;font-size:18px; font-weight:bolder;width:25%;">HR REVIEW SECTION</td>
  </tr>
</table>
<br>
</div>
...
<tr style="min-height:40px;background:lightblue;">
  <td colspan="4" class="" style="font-weight: bolder;">
   3. HR COMMENT AND APPROVAL
</td>
</tr>

<tr style="min-height:40px;">
  <td class="text-right" style="width:20%; background:lightblue;">
  EMPLOYEE
</td>
<td colspan="3" class="" style="min-height:40px;">
<?php echo $appraisal_array[0]['emp_first_name'].' '.$appraisal_array[0]['emp_last_name'].' ('.$appraisal_array[0]['emp_designation'].' '.$appraisal_array[0]['emp_department'].')';?>
</td>
</tr>
...
<td colspan="3" class="" style="min-height:40px;">
<?php echo $appraisal_array[0]['sup_first_name'].' '.$appraisal_array[0]['sup_last_name'].' ('.$appraisal_array[0]['sup_designation'].')';?>
</td>
</tr>

<tr style="min-height:40px;">
  <td class="text-center" style="width:20%; background:lightblue;">
  HR REVIEWER COMMENTS
</td>
<td colspan="3" class="text-center" style="min-height:40px;padding-left: 0px;">
<textarea form="appraisal_review_edit_1" class="form-control" name="comment" rows="2" style="border: 0px solid #ccc;"><?php echo $appraisal_array[0]['hr_review_comment'];?></textarea>
</td>
</tr>

<tr style="min-height:40px;">
  <td class="text-center" style="width:20%; background:lightblue;">
  HR REVIEWER NAME AND POSITION:
</td>
<td class="" style="min-height:40px;">
<?php echo $appraisal_array[0]['hr_first_name'].' '.$appraisal_array[0]['hr_last_name'].' ('.$appraisal_array[0]['hr_designation'].')';?>
</td>
<td class="text-center" style="width:20%; background:lightblue;">
DATE
</td>
...
<tr style="min-height:40px;">
  <td colspan="4" class="text-center" style="color:#f00;min-height:40px;">
   &nbsp;
</td>
</tr>
...
<tr style="min-height:40px;">
  <td colspan="4" class="text-center" style="color:#f00;min-height:40px;">
  <br>
  Please fill up all the above field and press the below button to finish.<br><br>
...
<td colspan="4" class="text-center">
  <input form="appraisal_review_edit_1" name="uid" type="hidden" value="<?php echo $_REQUEST['uid'];?>">
<button form="appraisal_review_edit_1" type="submit" class="btn btn-primary" name="button" value="save" <?php echo $disabled_1; ?>>Submit and Finish</button>
  </td>
</tr>
