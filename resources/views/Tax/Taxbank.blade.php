            ...
            <div class="container">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Add New Tax Bank</h3>
                    </div>
                    <div class="panel-body">
                        <form id="jobNatureForm" class="form-inline">
                            <div class="form-group">
                                <input type="text" id="name" class="form-control" placeholder="Tax Bank Name"
                                    required>
                                 <input type="text" id="description" class="form-control" placeholder="description"
                                    required>
                            </div>
                            <button type="button" id="saveBtn" class="btn btn-primary">Add Tax Bank</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Tax Bank List</h3>
                    </div>
                    <div class="panel-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveBtn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        toastr.success('Tax Bank added successfully.');
                        loadJobNatures();
                        $('#name').val('');
                        $('#description').val('');
            ...
            function loadJobNatures() {
                $.get('/tax-bank', function(response) {
                    var rows = '';
