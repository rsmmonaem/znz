...
Class TodoController extends Controller{
	...
	public function store(TodoRequest $request, Todo $todo){	
		...
		$this->logActivity(['module' => 'todo','unique_id' => $todo->id,'activity' => 'activity_added']);
	...
	public function update(TodoRequest $request, Todo $todo){
		...
		$data = $request->all();
		$todo->fill($data)->save();
		$this->logActivity(['module' => 'todo','unique_id' => $todo->id,'activity' => 'activity_updated']);
	...
	public function destroy(Todo $todo){
        $todo->delete();
		$this->logActivity(['module' => 'todo','unique_id' => $todo->id,'activity' => 'activity_deleted']);
