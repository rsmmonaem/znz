...
class EmpoloyeeCreate extends Controller
{
    ...
    {
        try {
            $oldUsers = DB::table('tbluser')->where("BranchName","Cheongshing Chainese Restaurant Ltd. Banani")->get();
            ...
            return response()->json([
                'status' => 'success',
                'message' => $migrated . ' user(s) migrated successfully to cheong shing restaurant!'
            ]);
